  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-8 relative">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className={`md:w-1/2 transition duration-1000 ${isAnimated ? 'opacity-100' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10">
              <Link to="/pools" className="px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 rounded-lg shadow-lg shadow-pink-500/20 transition duration-300 font-medium text-lg text-center">
                Play Now
              </Link>
              <Link to="/howitworks" className="px-8 py-4 flex items-center justify-center bg-gray-800 border border-gray-700 hover:bg-gray-700 text-gray-300 rounded-lg transition duration-300 font-medium text-lg">
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <div className="mt-2 h-2 bg-gray-700 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-pink-500 to-purple-500 rounded-full animate-pulse" style={{width: '75%'}}></div>
                      </div>
                    </div>
                    <div>
                  ...
                  <div className="bg-gray-900 bg-opacity-50 p-4 rounded-lg mb-6 border border-gray-700">
                    <div className="flex">
                      <div className="flex-shrink-0">
                        <svg className="h-5 w-5 text-pink-400 mt-0.5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2h-1V9z" clipRule="evenodd" />
                        </svg>
                      </div>
                      <div className="text-sm text-gray-300">
                        <span className="font-semibold text-pink-400">Game Rules:</span> Choose heads or tails each round. Players picking the majority option are eliminated. Last player standing wins the prize!
                      </div>
                    </div>
                  </div>
        ...
        <div className={`mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 transition duration-1000 delay-500 ${isAnimated ? 'opacity-100' : 'opacity-0 translate-y-8'}`}>
